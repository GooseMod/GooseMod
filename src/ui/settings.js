  ...
  goosemodScope.settingsUninjects.push(goosemodScope.patcher.patch(ConnectedPrivateChannelsList, 'default', (_args, res) => {
    ...
    () => React.createElement(LinkButton, {
      ...
      onClick: () => {
        ...
        [...document.querySelector(`.scroller-1JbKMe`).children[0].children].filter(x => x.localName === "a").forEach((x) => x.className = x.className.replace(LinkButtonClasses.selected, LinkButtonClasses.clickable));
